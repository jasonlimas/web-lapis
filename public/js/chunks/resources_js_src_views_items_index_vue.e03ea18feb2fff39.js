          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_2__["default"].get('/api/items');

              case 3:
                response = _context.sent;
                items_all.value = items.value = response.data;
                _context.next = 10;
                break;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                _context2.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/api/items/".concat(item.id));

              case 3:
                items.value = items.value.filter(function (d) {
                  return d.id !== item.id;
                });
                sweetalert2__WEBPACK_IMPORTED_MODULE_1___default().fire('Deleted!', 'Your item has been deleted.', 'success');
                _context2.next = 10;
                break;
