...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var params = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)({
      ...
      from: {
        name: 'LapisKu Cakes',
        email: 'lapisku_cakes@yahoo.co.id',
        address: 'Jakarta, Indonesia',
        phone: '0815 1026 6501'
      },
      to: {
        name: '',
        email: '',
      ...
      bank_info: {
        no: '598 009 0819',
        name: 'BCA a/n Fransiska Susan Margono'
      },
      notes: ''
    });
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 2:
              ...
              _context5.next = 7;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"].put("/api/sales-orders/".concat(route.params.id), payload);
            case 7:
