...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
    ...
    var invoiceId = route.params.id; // Assuming you pass the invoice ID as a route parameter
    ...
    var fetchInvoiceData = /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"].get("/api/sales-orders/".concat(invoiceId));
            case 3:
              response = _context4.sent;
              invoice = response.data;
              params.value.invoice_no = invoice.so_nbr;
              params.value.to.name = invoice.so_cust;
              params.value.invoice_date = new Date(invoice.so_ord_date).toISOString().substr(0, 10);
              params.value.due_date = new Date(invoice.due_date).toISOString().substr(0, 10);
              ...
              items.value = invoice.items.map(function (item, index) {
                return {
                  id: index + 1,
                  title: item.item_id,
                  rate: item.price,
            ...
            case 19:
              ...
              console.error('Error fetching invoice data:', _context4.t0);
            case 22:
            case "end":
      ...
      return function fetchInvoiceData() {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            ...
            case 2:
              ...
              _context5.next = 7;
              return axios__WEBPACK_IMPORTED_MODULE_8__["default"].put("/api/sales-orders/".concat(invoiceId), payload);
            case 7:
