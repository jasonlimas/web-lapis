...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  setup: function setup(__props, _ref) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              _context2.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_6__["default"].get('/api/customers');
            case 3:
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_6__["default"].get('/api/items');
            case 3:
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              _context4.prev = 0;
              _context4.next = 3;
              return axios__WEBPACK_IMPORTED_MODULE_6__["default"].get('/api/next-invoice-number');
            case 3:
          ...
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              payload = {
                ...
                // Ensure this holds the correct customer code
                so_ord_date: params.value.invoice_date,
                so_total: totalAmount.value,
                items: items.value.map(function (item) {
                  return {
                    item_id: item.title,
                    qty: item.quantity,
                    price: item.rate,
              ...
              _context5.next = 4;
              return axios__WEBPACK_IMPORTED_MODULE_6__["default"].post('/api/sales-orders', payload);
            case 4:
              response = _context5.sent;
              _context5.next = 7;
              return fetchNextInvoiceNumber();
            case 7:
              // Fetch the next invoice number after successfully creating a sales order
              params.value.invoice_no = nextInvoiceNumber.value; // Update the invoice number for the new form
            ...
            case 11:
              ...
              alert('Error creating sales order: ' + _context5.t0.response.data.message);
            case 16:
            case "end":
    ...
    // Function to redirect to /invoices
    var redirectToInvoices = function redirectToInvoices() {
...
var _hoisted_112 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("p", {
  "class": "my-4"
}, "The invoice has been created successfully.", -1 /* HOISTED */);
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, "Tambah")])])])])])])])])]), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)(" Success Modal "), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)(_component_b_modal, {
    ref: "successModal",
    title: "Invoice Created",
    "ok-title": "OK",
    onOk: $setup.redirectToInvoices
  }, {
