    ...
    <div class="sidebar-wrapper sidebar-theme">
        <nav ref="menu" id="sidebar">
            ...
            <perfect-scrollbar class="list-unstyled menu-categories" tag="ul" :options="{ wheelSpeed: 0.5, swipeEasing: !0, minScrollbarLength: 40, maxScrollbarLength: 300, suppressScrollX: true }">
                ...
                <!-- ORDERS MENU -->
                <li class="menu">
                    <a class="dropdown-toggle" data-bs-toggle="collapse" data-bs-target="#orders" aria-controls="orders" aria-expanded="false">
                        <div class="">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                    ...
                    <ul id="orders" class="collapse submenu list-unstyled" data-bs-parent="#sidebar">
                        <li>
                            <router-link to="/orders/invoices" @click="toggleMobileMenu">Invoices</router-link>
                        </li>
                    </ul>
                </li>
